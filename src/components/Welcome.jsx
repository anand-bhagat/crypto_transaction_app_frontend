    ...
    return (
        <div className="flex w-full justify-center ">
            <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md-mr-1">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">Send Crypto</h1>
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">across the world</h1>
